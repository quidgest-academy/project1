...
export default {
  ...
  emits: ['update:modelValue', 'search', 'search-change', 'select', 'tag', 'remove', 'close', 'open'],
  mounted () {
    /* istanbul ignore else */
  ...
  methods: {
    ...
    isSelected (option) {
      ...
      return (typeof opt === 'object' ?
        this.valueKeys.findIndex(function (vk) { return _this.compareValues(vk['Value'], opt['Value']); })
    ...
    removeElement (option, shouldClose = true) {
      ...
      const index = typeof option === 'object'
        ? (this.trackBy ? this.valueKeys.indexOf(option[this.trackBy]) : this.valueKeys.findIndex(function (vk) { return _this.compareValues(vk['Value'], option['Value']); }))
