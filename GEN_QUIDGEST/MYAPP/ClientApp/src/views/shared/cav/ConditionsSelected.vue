			...
			<div class="g-reporting__flow-content-selectable">
				<q-row-container is-large>
					<q-control-wrapper class="row-line-group">
						<q-accordion-container id="cav-conditions-select">
							<template
							...
							<div style="padding-left: 1.5rem">
								<div class="row">
									<div class="col-12">
										...
										<q-button
											b-style="secondary"
											@click="removeCondition(cond.internalKey)">
											<q-icon
												icon="bin"
...
<script>
	...
	export default {
		...
		methods: {
			...
			/**
			 * Toggles the state of a collapsible group in the condition builder UI.
			 * @param {string} groupId - The id of the group to toggle.
			 * @param {boolean} isOpen - Whether to open or close the group.
			 */
