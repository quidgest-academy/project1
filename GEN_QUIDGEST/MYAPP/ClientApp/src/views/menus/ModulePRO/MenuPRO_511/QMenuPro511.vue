...
<script>
	...
	import MenuViewModel from './QMenuPRO_511ViewModel.js'

	const requiredTextResources = ['QMenuPRO_511', 'hardcoded', 'messages']

/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL PRO FORM_INCLUDEJS PRO_MENU_511]/
...
/* eslint-enable indent, vue/html-indent, vue/script-indent */
	...
	export default {
		...
		data()
		{
			...
			const vm = this
			return {
				componentOnLoadProc: asyncProcM.getProcListMonitor('QMenuPRO_511', false),

				interfaceMetadata: {
					id: 'QMenuPRO_511', // Used for resources
				...
				controls: {
					menu: new controlClass.TableListControl({
						...
						groupFilters: [
							{
								id: 'filter_PRO_Menu_511_TIPOCONST',
								isMultiple: false,
								filters: [
									{
										id: 'filter_PRO_Menu_511_TIPOCONST_1',
										key: '1',
										value: computed(() => this.Resources.TODOS59977),
										selected: true
									},
									{
										id: 'filter_PRO_Menu_511_TIPOCONST_2',
										key: '2',
										value: computed(() => this.Resources.APARTAMENTO13855),
										selected: false
									},
									{
										id: 'filter_PRO_Menu_511_TIPOCONST_3',
										key: '3',
										value: computed(() => this.Resources.MORADIA65264),
										selected: false
									},
									{
										id: 'filter_PRO_Menu_511_TIPOCONST_4',
										key: '4',
						...
						uuid: 'f53956d2-c563-4f5b-8507-f6d13c1037df',
		...
		{
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL PRO FORM_CODEJS PRO_MENU_511]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		},
		...
		methods: {
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL PRO FUNCTIONS_JS PRO_511]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
/* eslint-disable indent, vue/html-indent, vue/script-indent */
// USE /[MANUAL PRO LISTING_CODEJS PRO_MENU_511]/
// eslint-disable-next-line
/* eslint-enable indent, vue/html-indent, vue/script-indent */
		}
	}
