...
namespace CSGenio.framework
{
    ...
    public static class Configuration
    {
        ...
        /// Application version
        /// </summary>
        public static int Version { get; } = 2541;

        /// <summary>
        /// System id
        /// </summary>
        public static string Program { get; } = "PRO";
        ...
        /// </summary>
        public const int VersionDbGen = 2541;

        /// <summary>
        /// Version of the database indexes
        /// </summary>
        public const int VersionIdxDbGen = 41;
        ...
        /// </summary>
        public const string GenioVersion = "349.60";
        ...
        {
			// USE /[MANUAL PRO RESOLVEDATASYSTEM]/
            DataSystemXml ds;
            switch (db)
            {
