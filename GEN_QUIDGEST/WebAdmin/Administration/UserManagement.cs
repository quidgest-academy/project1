...
namespace Administration
{
    ...
    public class UserManagement : IUserManagementService
    {
        ...
        public List<ModulesLevel> GetPermissions()
        {
            ...
            perm.Add(new ModulesLevel("PRO", Resources.Resources.MY_APPLICATION56216, "1", Resources.Resources.CONSULTA40695));
            perm.Add(new ModulesLevel("PRO", Resources.Resources.MY_APPLICATION56216, "2", Resources.Resources.ADMINISTRATIVA24751));
            perm.Add(new ModulesLevel("PRO", Resources.Resources.MY_APPLICATION56216, "3", Resources.Resources.AGENTE44214));
            perm.Add(new ModulesLevel("PRO", Resources.Resources.MY_APPLICATION56216, "99", Resources.Resources.ADMINISTRADOR57294));
        ...
        public bool CreateUserWithPassAndLevels(string username, string password, List<ModulesLevel> levels)
        {
            ...
            try
            {
                ...
                CSGenioApsw userPsw = new CSGenioApsw(user, "PRO");
