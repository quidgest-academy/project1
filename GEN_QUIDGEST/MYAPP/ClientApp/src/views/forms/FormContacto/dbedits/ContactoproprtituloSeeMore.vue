<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-contactoproprtitulo-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CONTACTOPROPRTITULO___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'ContactoproprtituloSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CONTACTOPROPRTITULO___SeeMore', false),

				interfaceMetadata: {
					id: 'CONTACTOPROPRTITULO___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CONTACTOPROPRTITULO___SeeMore',
					name: 'CONTACTOPROPRTITULO___SeeMore',
					controller: 'CONTC',
					action: 'CONTACTO_ProprValTitulo'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-contactoproprtitulo',
				headerTitle: computed(() => this.Resources.PROPRIEDADES45924),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'CONTACTOPROPRTITULO__'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-contactoproprtitulo')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Contacto_Contacto_ProprValTitulo',
