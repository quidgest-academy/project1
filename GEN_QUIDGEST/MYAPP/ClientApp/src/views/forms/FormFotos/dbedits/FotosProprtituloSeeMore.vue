<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-fotos-proprtitulo-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['FOTOS___PROPRTITULO___SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'FotosProprtituloSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('FOTOS___PROPRTITULO___SeeMore', false),

				interfaceMetadata: {
					id: 'FOTOS___PROPRTITULO___SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'FOTOS___PROPRTITULO___SeeMore',
					name: 'FOTOS___PROPRTITULO___SeeMore',
					controller: 'ALBUM',
					action: 'FOTOS_ProprValTitulo'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				...
				isActive: true,
				returnElement: 'FOTOS___PROPRTITULO__'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-fotos-proprtitulo')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Fotos_Fotos_ProprValTitulo',
