<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-propriedagentnome-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PROPRIEDAGENTNOME_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PropriedagentnomeSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PROPRIEDAGENTNOME_____SeeMore', false),

				interfaceMetadata: {
					id: 'PROPRIEDAGENTNOME_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PROPRIEDAGENTNOME_____SeeMore',
					name: 'PROPRIEDAGENTNOME_____SeeMore',
					controller: 'PROPR',
					action: 'PROPRIED_AgentValNome'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-propriedagentnome',
				headerTitle: computed(() => this.Resources.AGENTES_IMOBILIARIO54381),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'PROPRIEDAGENTNOME____'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-propriedagentnome')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Propried_Propried_AgentValNome',
