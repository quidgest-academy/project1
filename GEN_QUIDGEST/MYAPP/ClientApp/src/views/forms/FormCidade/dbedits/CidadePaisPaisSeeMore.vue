<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-cidade-pais-pais-body">
		<q-row-container>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['CIDADE__PAIS_PAIS_____SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'CidadePaisPaisSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('CIDADE__PAIS_PAIS_____SeeMore', false),

				interfaceMetadata: {
					id: 'CIDADE__PAIS_PAIS_____SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'CIDADE__PAIS_PAIS_____SeeMore',
					name: 'CIDADE__PAIS_PAIS_____SeeMore',
					controller: 'CIDAD',
					action: 'CIDADE_PaisValPais'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-cidade-pais-pais',
				headerTitle: computed(() => this.Resources.PAISES47908),
				closeButtonEnable: true,
				hideFooter: true,
				dismissWithEsc: true,
				dismissAction: this.close,
				isActive: true,
				returnElement: 'CIDADE__PAIS_PAIS____'
			}
		...
		beforeUnmount()
		{
			...
			genericFunctions.removeModal('see-more-cidade-pais-pais')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						config: {
							name: 'Cidade_PaisValPais',
							serverMode: true,
							pkColumn: 'ValCodpais',
							tableAlias: 'PAIS',
							tableNamePlural: computed(() => this.Resources.PAISES47908),
							viewManagement: '',
							showLimitsInfo: true,
							tableTitle: '',
						...
						changeEvents: ['changed-PAIS'],
						uuid: 'Cidade_Cidade_PaisValPais',
