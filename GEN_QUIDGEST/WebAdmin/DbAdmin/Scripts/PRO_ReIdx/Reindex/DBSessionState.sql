...
SET @SQL = N'
CREATE DATABASE [ASPStatePRO]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStatePRO'', FILENAME = N''' + @SQLDataFolder + 'ASPStatePRO.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStatePRO_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStatePRO_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStatePRO_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStatePRO_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStatePRO_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStatePRO] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStatePRO] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
