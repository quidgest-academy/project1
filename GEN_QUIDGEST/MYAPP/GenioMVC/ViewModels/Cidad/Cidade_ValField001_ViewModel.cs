...
{
	public class Cidade_ValField001_ViewModel : ListViewModel
	{
		/// <summary>
		...
		/// <inheritdoc/>
		public override string Uuid { get => "Cidade_ValField001"; }
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="Cidade_ValField001_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public Cidade_ValField001_ViewModel(UserContext userContext) : base(userContext)
		{
			ValCodcidad = userContext.CurrentNavigation.CurrentLevel.GetEntry("cidad")?.ToString();
		}
		...
		public override List<Exports.QColumn> GetColumnsToExport(bool ajaxRequest = false)
		{
			var columns = new List<Exports.QColumn>()
			{
				...
				new Exports.QColumn(CSGenioApropr.FldLocaliza, FieldType.GEOGRAPHY, Resources.Resources.LOCALIZACAO54665, 30, 0, true),
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			if (this.ValCodcidad != null)
				crs.Equal(CSGenioApropr.FldCodcidad, this.ValCodcidad);
			...
			{
				// EPH
				crs = Models.Propr.AddEPH<CSGenioApropr>(ref u, crs, "IBL_CIDADE__PSEUDFIELD001");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Propr.AddEPH<CSGenioApropr>(ref u, null, "IBL_CIDADE__PSEUDFIELD001"));
			}
		...
		public void Load(CSGenio.framework.TableConfiguration.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioApropr> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet cidade__pseudfield001Conds = CriteriaSet.And();
...
FieldRef[] fields = new FieldRef[] { CSGenioApropr.FldCodpropr, CSGenioApropr.FldZzstate, CSGenioApropr.FldFoto, CSGenioApropr.FldLocaliza, CSGenioApropr.FldTitulo };
			...
			if (sorts == null)
				if (userColumns != null)
				{
					...
					firstVisibleColumn = new FieldRef("propr", "foto");
			...
			//Tooltip for EPHs affecting this viewmodel list
			{
				...
				List<Limit> area_EPH_limits = EPH_Limit_Filler(ref limit, model_limit_area, "IBL_CIDADE__PSEUDFIELD001");
			...
			conditions.SubSets.Add(cidade__pseudfield001Conds);
			cidade__pseudfield001Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL PRO OVERRQ CIDADE_PSEUDFIELD001]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.Where<CSGenioApropr>(m_userContext, false, cidade__pseudfield001Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CIDADE__PSEUDFIELD001", true, firstVisibleColumn: firstVisibleColumn);

// USE /[MANUAL PRO OVERRQLSTEXP CIDADE_PSEUDFIELD001]/
			...
			if (tableReload)
			{
// USE /[MANUAL PRO OVERRQLIST CIDADE_PSEUDFIELD001]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioApropr.GetInformation(), QMVC_POS_RECORD, sorts, cidade__pseudfield001Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioApropr> listing = Models.ModelBase.Where<CSGenioApropr>(m_userContext, false, cidade__pseudfield001Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "IBL_CIDADE__PSEUDFIELD001", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn);
				...
				Menu.Elements = MapCidade_ValField001(listing);

				Menu.Identifier = "IBL_CIDADE__PSEUDFIELD001";

				// Last updated by [CJP] at [2015.02.03]
				// Adds the identifier to each element
				foreach (var element in Menu.Elements)
					element.Identifier = "IBL_CIDADE__PSEUDFIELD001";
		...
		private List<Models.Propr> MapCidade_ValField001(ListingMVC<CSGenioApropr> Qlisting)
		{
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapCidade_ValField001(row));
					i++;
				}
			}
		...
		private Models.Propr MapCidade_ValField001(CSGenioApropr row)
		{
		...
		#region Custom code
// USE /[MANUAL PRO VIEWMODEL_CUSTOM CIDADE_VALFIELD001]/
		#endregion

		private static readonly string[] _fieldsToSerialize =
		{
			"Propr", "Propr.ValCodpropr", "Propr.ValZzstate", "Propr.ValFoto", "Propr.ValLocaliza", "Propr.ValTitulo", "Propr.ValCodagent", "Propr.ValCodcidad"
		};
