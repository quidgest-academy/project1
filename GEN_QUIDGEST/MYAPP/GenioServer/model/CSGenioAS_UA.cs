...
namespace CSGenio.business
{
	...
	public class CSGenioAs_ua : DbArea	{
		...
		public CSGenioAs_ua(User user, string module)
		{
			...
			// USE /[MANUAL PRO CONSTRUTOR S_UA]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("psw", new Relation("PRO", "userauthorization", "s_ua", "codua", "codpsw", "PRO", "userlogin", "psw", "codpsw", "codpsw"));
		}
